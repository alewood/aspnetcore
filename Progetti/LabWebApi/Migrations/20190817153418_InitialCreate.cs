        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Prenotazione_AspNetUsers_UtenteId",
                        column: x => x.UtenteId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DettaglioPrenotazione", x => new { x.IdStrumento, x.IdPrenotazione });
                    table.ForeignKey(
                        name: "FK_DettaglioPrenotazione_Prenotazione_PrenotazioneID",
                        column: x => x.PrenotazioneID,
                        principalTable: "Prenotazione",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DettaglioPrenotazione_Strumento_StrumentoID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DettaglioPrenotazione_PrenotazioneID",
                table: "DettaglioPrenotazione",
                column: "PrenotazioneID");

            migrationBuilder.CreateIndex(
                name: "IX_DettaglioPrenotazione_StrumentoID",
                table: "DettaglioPrenotazione",
                column: "StrumentoID");

            migrationBuilder.CreateIndex(
                name: "IX_Prenotazione_UtenteId",
                table: "Prenotazione",
                column: "UtenteId");
        }
